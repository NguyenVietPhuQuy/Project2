...
function tableData(data) {
    ...
    <th>${valTable.type}</th>
    <th>
    <button class="btn btn-danger" onclick=" deleteEmployee('${valTable.employeeID}') "> Xóa </button> <button class="btn btn-danger" onclick=" deleteEmployee('${valTable.employeeID}') "> Xóa </button>
    </th>
    </tr>
     `
    }

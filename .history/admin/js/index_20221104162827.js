...
function getInformation(val) {
    ...
    let val = findID(getValue);
    axios(
        {
           url: `https://635205159d64d7c7130c9c5f.mockapi.io/products/${val}`,
           method:"GET"
        }
    )
    .then(function(response){
        ...
        document.getElementById('backCamera').value = returnInformation.back;
        document.getElementById('frontCamera').value = returnInformation.front;
        document.getElementById('img').value = returnInformation.imgProduct;
        document.getElementById('information').value = returnInformation.desk;

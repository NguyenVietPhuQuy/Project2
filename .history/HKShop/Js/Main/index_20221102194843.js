         ...
         <tr>
            ...
            <td>
                <div style="width: 20px">
                   <button type="button" style="width: 100%;text-align:center" onclick="changeQuatityPlus('${item.id}')">+</button>
                   <div class="number" style="width: 100%";text-align:center>${item.quantity}</div>
                   <button type="button"style="width: 100%;text-align:center" onclick="changeQuatityMinus('${item.id}')">-</button>
                </div>
            </td>

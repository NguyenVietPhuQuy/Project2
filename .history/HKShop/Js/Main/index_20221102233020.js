    ...
    dataSaving.forEach(item => {
        content += `
         <tr>
            ...
            <td>
                <div>
                   <button type="button" style="width: 15px; border-radius:5px 5px 0 0" onclick="changeQuatityPlus('${item.id}')">+</button>
                   <div class="number" style="width: 100%;display:flex;justify-content:center"; >${item.quantity}</div>
                   <button type="button"style="width: 15px;border-radius:0 0 5px 5px; " onclick="changeQuatityMinus('${item.id}')">-</button>
                </div>
            </td>

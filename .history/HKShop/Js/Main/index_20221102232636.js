    ...
    dataSaving.forEach(item => {
        content += `
         <tr>
            ...
            <td>
                <div>
                   <button type="button" style="width: 20px; border-radius:10px 10px -10px -10px" onclick="changeQuatityPlus('${item.id}')">+</button>
                   <div class="number" style="width: 100%;display:flex;justify-content:center"; >${item.quantity}</div>
                   <button type="button"style="width: 20px;border-radius:0 0 20px 20px " onclick="changeQuatityMinus('${item.id}')">-</button>
                </div>
            </td>
